...
def get_krr_coeff(K, y, default_sigma, y_sigma=None, rcond=None, mc=None):
    ...
    y_sigma : np.ndarray (N), optional
        If given the specified regularization parameter
...
def get_prediction(K_test, coeff, mc=None):
    """
    Predict using the kernel ridge coeffs.
...
def grid_search_1d_validation_set(K_train, K_val, y_train, y_val, sigmas, destination='./Results_validation_set', mc=None):
        """
        ...
        # Saves the hyperparameter surface
